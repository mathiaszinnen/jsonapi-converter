...
//
//    private JsonApiResponse2(UriInfo uriInfo, Response.StatusType statusCode) {
...
//     */
//    private JsonApiResponse2(Response.StatusType statusCode) {
...
//
//        return new Builder(new JsonApiResponse2(uriInfo, Response.Status.OK));
//    }
//
//
...
//        Assert.assertNotNull(uriInfo);
//
//        return new Builder(new JsonApiResponse2(uriInfo, Response.Status.CREATED));
//    }
//
//
...
//
//        return new Builder(new JsonApiResponse2(code));
//    }
//
...
//
//        private final JsonApiResponse2 instance;
//
//        public Builder(JsonApiResponse2 instance) {
...
//
//        @Override
//        public WithRelationship addRelationship(String name, Collection<?> entityCollection, URI location) {
//            Assert.assertNotNull(entityCollection);
...
//
//        @Override
//        public WithRelationship addIncluded(Object included) {
...
//
//
//        private void assertHasRelationship(Object relationship) {
...
//         */
//        Buildable data(Object entity);
//
//        Buildable data(Collection<?> entityCollection);
//    }
//
//
//    /**
...
//         * @return a buildable Responsebuilder on which addIncluded() can be called.
//         */
//        WithRelationship addRelationship(String name, Collection<?> entityCollection, URI location);
//    }
//
//
//    /**
...
//         * @return a buildable ResponseBuilder on which addIncluded() can be called.
//         */
//        WithRelationship addIncluded(Object included);
//    }
//
//}
//
